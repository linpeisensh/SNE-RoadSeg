...
class BaseOptions():
    ...
    def initialize(self, parser):
        parser.add_argument('--dataroot', type=str, default='examples', help='path to images, should have training, validation and testing')
        ...
        parser.add_argument('--name', type=str, default='kitti', help='name of the experiment. It decides where to store samples and models')
        parser.add_argument('--use_sne', type=bool, default=True, help='chooses if using sne')
        ...
        parser.add_argument('--epoch', type=str, default='kitti', help='chooses which epoch to load')
